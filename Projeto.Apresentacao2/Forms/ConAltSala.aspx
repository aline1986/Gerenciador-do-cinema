<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConAltSala.aspx.cs" Inherits="Projeto.Apresentacao2.Forms.ConAltSala" %>
                        ...
                        /// Codigo do(a) Usuario(a) Administrador(a)
                            ...
                            <tr>
                               ...
                               <td><center><%: ls.Nome %></center></td>
                                ...
                                <td><center><a href="#?Id=<%: ls.Id %>" class="btn-primary btn-sm">o</a></center></td>
                            </tr>
                        <% } %>
