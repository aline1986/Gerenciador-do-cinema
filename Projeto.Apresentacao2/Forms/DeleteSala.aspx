<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteSala.aspx.cs" Inherits="Projeto.Apresentacao2.Forms.DeleteSala" %>
...
<form id="form1" action="#" runat="server" style="margin-left: 50px">
        <div>
            ...
            <%  
                try
                {
                    ...
                    string Id = Request.QueryString["Id"];
                        ...
                        SqlCommand com = new SqlCommand("DELETE FROM Lista_de_salas  Where Id = " + Id, con);
                        com.ExecuteReader();
          ...
          <script>
                window.location.href = "../Home/ExcluirSucessoSala";
            </script>          
        ...
        /// Fecha a Conexao
                    ...
                    %> 
             <script>
                window.location.href = "../Home/ExcluirErroSala";
            </script>          
